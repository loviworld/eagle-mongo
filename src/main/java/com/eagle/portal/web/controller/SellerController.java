...
public class SellerController extends ControllerBase{
	...
	public String getNewSellerPage(Model model){
		...
		return "portal/seller/new-seller";
	}
	
	@RequestMapping(value="/email-verification",method=RequestMethod.POST)
	public @ResponseBody PostResponse  emailVerification(@RequestParam String email){
		//do email verification....
		PostResponse response = new PostResponse();
		response.setResult("SUCCESS - " + email);
		return response;
	}
	...
	public @ResponseBody PostResponse  persistSellerStep1(@ModelAttribute() SellerDto sellerDto){
        ...
        seller.setIsDealer(sellerDto.getIsDealer());
	...
	public @ResponseBody PostResponse  persistSellerStep2(@ModelAttribute() SellerDto sellerDto){
        ...
        country.setId(sellerDto.getContactInfo().getCountry().getId());
