...
<spring:message code="buyer.new_buyer.step_2.individual_buyer.h1" var="h1" scope="page"/>
<spring:message code="buyer.new_buyer.step_2.individual_buyer.h2" var="h2" scope="page"/>
<spring:message code="buyer.new_buyer.step_2.buyer_category.individual_buyer" var="buyer_category" scope="page"/>

<div ng-controller="StepTwoCtrlIndividualBuyer">
    <h1>${h1}</h1>
    <h3>${h2}</h3>
    ...
    <table>
        <tr>
            <td align="center">
                ...
                <table>
                    <tbody>
                    <tr ng-repeat="fData in individualBuyerFormData">
                        <td>{{fData.text}}</td>
